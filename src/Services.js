          ...
          <div className="line"></div>
            <div className="service_corp">
              ...
              <ul className="li-corp-all">
                <Link to="/office"><li className="li-corp">-Офисам</li></Link>
                <Link to="/shops"><li className="li-corp">-Магазинам и торговым центрам</li></Link>
                <Link to="/hotel"><li className="li-corp">-Уборка отелей (гостиниц)</li></Link>
                <Link to="/cleaningIndustrial"><li className="li-corp">-Уборка промышленных и производственных площадей</li></Link>
              </ul>  
              </div>
          </div>
      </>
